...
import ToolbarComponent from './stream/toolbar/ToolbarComponent';
// import GmModel from '../models/gm-model';

// var gmUser = new GmModel();
...
class VideoRoomComponent extends Component {
    ...
    subscribeToStreamCreated() {
        this.state.session.on('streamCreated', (event) => {
            ...
            console.log('새로운 유저 확인', subscriber)
    ...
    render() {
        ...
        const userType = this.state.myUserType
        var chatDisplay = { display: this.state.chatDisplay };
        // console.log('subscribers', typeof(this.state.subscribers[1]))
            ...
            <div className="video-container">
                ...
                <div id="session">
                    ...
                    <div id="layout" className="bounds">
                        {this.state.getplayers.map((player, i) => (
                                <div key={i} className="OT_root OT_publisher custom-class" id="users">
                                    {/* <p>{player.auth}</p> */}
                                    <StreamComponent user={player} streamId={player.streamManager.stream.streamId} />
                                </div>
                        ))}
                        {/* {this.state.getplayers.map((sub, i) => ( //foreach써보자
                            <div className="OT_root OT_publisher custom-class" id="users">
                                <p>{this.state.getplayers[0].auth}</p>
    ...
    createSession(sessionId) {
        return new Promise((resolve, reject) => {
            console.log(btoa('OPENVIDUAPP:' + this.OPENVIDU_SERVER_SECRET))
