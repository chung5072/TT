...
import chaos from '../../assets/image/monster/kobolt.png'
        ...
        <div id="monster">
          ...
          <Slider className="monster-carousel" {...settings}>
              <div className="monster1">
                {mapStatus === 1 ? <img src={kobolt} alt="코볼트" /> : mapStatus === 2 ? <img src={kokatris} alt="코카트리스"/> : mapStatus === 3 ? <img src={dwarf} alt="드워프전사" /> : mapStatus === 4 ? <img src={bugman} alt="인면충" /> : <img src={minotauros} alt="미노타우르스" /> }
              ...
              <div className="monster2">
                {mapStatus === 1 ? <img src={domabaemman} alt="도마뱀인간" /> : mapStatus === 2 ? <img src={griffin} alt="그리폰"/> : mapStatus === 3 ? <img src={jihain} alt="지하인" /> : mapStatus === 4 ? <img src={chaindevil} alt="사슬악마" /> : <img src={fish} alt="아볼레스" /> }
              ...
              <div className="monster3">
                {mapStatus === 1 ? <img src={crocodile} alt="거대악어" /> : mapStatus === 2 ? <img src={ogre} alt="오거"/> : mapStatus === 3 ? <img src={spiderking} alt="거미왕" /> : mapStatus === 4 ? <img src={devil} alt="가시악마" /> : <img src={dragon} alt="용" /> }
              ...
              <div className="monster4">
                {mapStatus === 1 ? <img src={koatle} alt="코아틀" /> : mapStatus === 2 ? <img src={chaos} alt="혼돈의즙"/> : mapStatus === 3 ? <img src={otuge} alt="오튜그" /> : mapStatus === 4 ? <img src={angel} alt="천사" /> : <img src={enddragon} alt="종말의용" /> }
