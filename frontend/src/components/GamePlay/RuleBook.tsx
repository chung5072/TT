...
export default function RuleBook() {
  ...
  const sk = {name:"사격", explain:"멀리서 적을 겨누고 쏘면 +민 판정을 합니다.", choice:["깔끔하게 명중하여 피해를 줍니다.", "* 쏘려고 자세를 바꾸거나 자리를 옮기는 바람에 곤경에 처합니다.(세부사항은 마스터가 정합니다.)\n\ * 악조건에서 쏘아 위력이 약하거나 효과가 떨어집니다.\n\ (-1D6 피해)\n\ 중 하나를 선택합니다.(어느 것을 골라도 피해는 줍니다.)"]}
  ...
  * 여기서 겉보기와 다른 것은 무엇인가?", choice:["다음 목록에서 셋을 골라 마스터에게 질문하십시오", "하나만 골라서 묻습니다."]}
  ...
  const gmGuide = {
    ...
    describtion: ["괴물이 무엇을 하고 어떤 문제를 일으키는지", "크기와 공격 방식"]
  }
  ...
  const jobSetting = {
    ...
    온 세상에 가르쳐 주십시오, 누가 우주의 진정한 주인이신지.", "남을 치유하기 위해 스스로 위험에 빠트림", "교회의 교리나 신의 가르침을 따르기 위해서 스스로를 위험에 빠트립니다.", "남을 해침으로 자기의 교회나 신의 우월함을 증명합니다."],
        ...
        <div id='rulebook'>
          ...
          <Slider className="rulebook-carousel" {...settings}>
            <div className="rule-action">
              <h3>액션 가이드</h3>
              <div>
                <div>{basic.explain}</div>
                <div>10+:{basic.choice[0]}</div>
                <div>7~9:{basic.choice[1]}</div>
                <div>6-:{basic.choice[2]}</div>
              </div>
              <div>
                <div>{jkj.name}</div>
                <div>{jkj.explain}</div>
                <div>10+:{jkj.choice[0]}</div>
                <div>7~9:{jkj.choice[1]}</div>
              </div>
              <div>
                <div>{sk.name}</div>
                <div>{sk.explain}</div>
                <div>10+:{sk.choice[0]}</div>
                <div>7~9:{sk.choice[1]}</div>
              </div>
            </div>
            <div>
            <h3>액션 가이드</h3>
              <div>
                <div>{dd.name}</div>
                <div>{dd.explain}</div>
                <div>10+:{dd.choice[0]}</div>
                <div>7~9:{dd.choice[1]}</div>
              </div>
              <div>
                <div>{jd.name}</div>
                <div>{jd.explain}</div>
                <div>10+:{jd.choice[0]}</div>
                <div>7~9:{jd.choice[1]}</div>
              </div>
            </div>
            <div>
            <h3>액션 가이드</h3>
              <div>
                <div>{sp.name}</div>
                <div>{sp.explain}</div>
                <div>10+:{sp.choice[0]}</div>
                <div>7~9:{sp.choice[1]}</div>
              </div>
              <div>
                <div>{hs.name}</div>
                <div>{hs.explain}</div>
                <div>10+:{hs.choice[0]}</div>
                <div>7~9:{hs.choice[1]}</div>
              </div>
            </div>
            <div className="rule-character">
              <h3>캐릭터 만들기</h3>
              <div>
                <div>1. {character.one[0]}</div>
                <div>{character.one[1]}</div>
              </div>
              <div>
                <div>2. {character.two[0]}</div>
                <div>{character.two[1]}</div>
              </div>
              <div>
                <div>3. {character.three[0]}</div>
                <div>{character.three[1]}</div>
              </div>
              <div>
                <div>4. {character.four[0]}</div>
                <div>{character.four[1]}</div>
              </div>
              <div>
                <div>5. {character.five[0]}</div>
            ...
            <h3>캐릭터 만들기</h3>
              <div>
                <div>6. {character.six[0]}</div>
                <div>{character.six[1]}</div>
              </div>
              <div>
                <div>7. {character.seven[0]}</div>
                <div>{character.seven[1]}</div>
              </div>
              <div>
                <div>8. {character.eight[0]}</div>
            ...
            <div>
              ...
              <div>
                ...
                <div>가치관</div>
                <div>혼돈:{jobSetting.thief[1]}</div>
                <div>중립:{jobSetting.thief[2]}</div>
                <div>악:{jobSetting.thief[3]}</div>
              </div>
            </div>
            ...
            <div>
              <div>
                ...
                <div>{jobSetting.thief[0]}</div>
                <div>가치관</div>
                <div>혼돈:{jobSetting.wizard[1]}</div>
                <div>중립:{jobSetting.wizard[2]}</div>
                <div>악:{jobSetting.wizard[3]}</div>
              </div>
            </div>
            ...
            <div>
              <div>
                ...
                <div>가치관</div>
                <div>혼돈:{jobSetting.priest[1]}</div>
                <div>중립:{jobSetting.priest[2]}</div>
                <div>악:{jobSetting.priest[3]}</div>
              </div>
            </div>
            ...
            <div>
              <div>
                ...
                <div>가치관</div>
                <div>혼돈:{jobSetting.warrior[1]}</div>
                <div>중립:{jobSetting.warrior[2]}</div>
                <div>악:{jobSetting.warrior[3]}</div>
              </div>
            </div>  
            <div>
              <div>
                ...
                <div>가치관</div>
                <div>혼돈:{jobSetting.hunter[1]}</div>
                <div>중립:{jobSetting.hunter[2]}</div>
                <div>악:{jobSetting.hunter[3]}</div>
              </div>
            </div>
          </Slider>
        </div>
